...
public class BasisFileTemplateLoader extends AbstractTemplateLoader implements TemplateLoader {

	private static final FileTemplateLoader loader=new FileTemplateLoader();
