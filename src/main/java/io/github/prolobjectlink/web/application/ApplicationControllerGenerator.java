...
public abstract class ApplicationControllerGenerator extends AbstractWebApplication implements WebControllerGenerator {

	private final List<ServletUrlMapping> mappings;

	protected ApplicationControllerGenerator(String appName) {
		this(new Settings().load().getProvider(), appName);
	}

	protected ApplicationControllerGenerator(PrologProvider provider, String appName) {
		mappings = new ArrayList<ServletUrlMapping>();
		String controller = "controller.pl";
		String separator = File.separator;
		File file = new File(getWebDirectory() + separator + appName);
