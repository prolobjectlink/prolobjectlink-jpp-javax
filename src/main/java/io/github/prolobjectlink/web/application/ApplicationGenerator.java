	...
	public void generate(String name) {
		...
		try {
			...
			File application = new File(
					controllerFolder.getCanonicalPath() + File.separator + name + "_index_controller.pl");
			j = new PrintWriter(application);
			j.println();
			j.println(":-consult('../../../misc/pl/http.pl').");
			j.println();
			...
			a.print(name + "_controller('controller/" + name + "_controller.pl').");
			...
			l = new PrintWriter(new File(webdir + File.separator + name + File.separator + name + ".html"));
			l.write("");
