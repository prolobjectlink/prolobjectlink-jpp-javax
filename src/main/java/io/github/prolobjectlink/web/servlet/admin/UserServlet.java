...
@WebServlet
public class UserServlet extends AbstractServlet implements Servlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Template template = loader.load("/io/github/prolobjectlink/web/html/users.html");
		TemplateContext context = new TemplateContext();

		// list applications from abstract servlet
		Set<Entry<Object,Object>> users = listUsers();
