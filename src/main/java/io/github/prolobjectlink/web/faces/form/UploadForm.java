...
public class UploadForm extends AbstractFacesForm implements FacesForm {

	public UploadForm(String name, String action) {
		super(name, name, action, POST, "", "", "");
	}

	public UploadForm(String name, String action, String method) {
		super(name, name, action, method, "", "", "");
	}

	public UploadForm(String name, String action, String method, String enctype) {
