 ...
 * #L%
 */
package io.github.prolobjectlink.web.faces.report.pdf;
...
public class PortableDocumentFormat extends AbstractWebReport implements Platform {

	protected PortableDocumentFormat(String application, String destination) {
