 ...
 * --------- MS SQLServer (2008) (com.microsoft.sqlserver.jdbc.SQLServerDriver)
 ...
 * 
 */
public class MSSQLSERVERDriver extends RemoteDriver {

	private static final String port = ":1433";
	public static final String name = "MS SQLServer";
	public static final String prefix = "jdbc:sqlserver:";
	private static final String driver = SQLServerDriver.class.getName();

	public MSSQLSERVERDriver(Properties properties) {
		super(properties);
		this.dbport = port;
	...
	public MSSQLSERVERDriver(String dbhost, String dbport, String dbname, String dbuser, String dbpwd) {
		super(driver, prefix, dbhost, dbname, dbport, dbuser, dbpwd);
	}

	@Override
	public String getDbURL() {
		return dbprefix + "//" + dbhost + dbport + ";databaseName=" + dbname + "";
	}
	...
	public boolean createDatabase() throws SQLException {
		...
		String url = dbprefix + "//" + dbhost + ":" + dbport + "/" + ";databaseName=master";
