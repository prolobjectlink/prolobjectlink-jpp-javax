...
public final class H2FileDriver extends EmbeddedDriver {
	...
	public H2FileDriver(Properties properties) {
		super(properties);
		dbpath = properties.get("javax.persistence.jdbc.url").toString();
		dbprefix = prefix;
	}

	public H2FileDriver(String dbpath, String dbname, String dbuser, String dbpwd) {
