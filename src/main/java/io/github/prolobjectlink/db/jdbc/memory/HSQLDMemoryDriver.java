...
public final class HSQLDMemoryDriver extends MemoryDriver {

	public static final String name = "HSQLDB (File)";
	public static final String prefix = "jdbc:hsqldb:mem:";
	private static final String driver = jdbcDriver.class.getName();

	public HSQLDMemoryDriver(Properties properties) {
		super(properties);
//		dbpath = properties.get("javax.persistence.jdbc.url").toString();
		dbprefix = prefix;
	}

	public HSQLDMemoryDriver(String dbpath, String dbname, String dbuser, String dbpwd) {
