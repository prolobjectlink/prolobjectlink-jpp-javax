...
public final class JpaBetweenPredicate extends JpaPredicate {
	...
	public JpaBetweenPredicate(String alias, Class<? extends Boolean> javaType, Expression<?> expression,
	...
	public String toString() {
		return "JpaBetweenPredicate [expressions=" + expressions + ", operator=" + operator + ", metamodel=" + metamodel
