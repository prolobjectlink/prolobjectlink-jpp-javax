...
public class JpaNullPredicate extends JpaPredicate {
	...
	public JpaNullPredicate(String alias, Class<? extends Boolean> javaType, Expression<?> expression,
	...
	public String toString() {
		return "JpaNullPredicate [expressions=" + expressions + ", operator=" + operator + ", metamodel=" + metamodel
