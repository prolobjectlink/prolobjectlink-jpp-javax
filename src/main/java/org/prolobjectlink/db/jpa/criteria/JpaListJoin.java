...
public class JpaListJoin<Z, X> extends JpaJoin<Z, X> implements Join<Z, X> {

	public JpaListJoin(String alias, Class<? extends X> javaType, Expression<X> expression, Metamodel metamodel,
