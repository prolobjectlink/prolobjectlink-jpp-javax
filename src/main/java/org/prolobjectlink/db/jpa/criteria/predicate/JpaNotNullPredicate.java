...
public final class JpaNotNullPredicate extends JpaPredicate {

	public JpaNotNullPredicate(String alias, Class<? extends Boolean> javaType, Expression<?> expression,
